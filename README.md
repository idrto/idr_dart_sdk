...
Pure **Dart** package (no Flutter SDK dependency) for embedding the [idr.to](https://idr.to) agent via FFI to `libidr_sdk` (Rust [`idr-ffi`](https://github.com/idrto/agent/tree/main/crates/idr-ffi)).
...
This package is FFI bindings only. Build `libidr_sdk` from the [idr.to client](https://github.com/idrto/agent) repo:

```bash
git clone https://github.com/idrto/agent
cd client
...
Full matrix: [client docs/SDK.md](https://github.com/idrto/agent/blob/main/docs/SDK.md).
